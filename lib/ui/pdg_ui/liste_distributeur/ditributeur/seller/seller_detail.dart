...
class DistPaysSellerDetail extends ConsumerStatefulWidget {
  const DistPaysSellerDetail({
    super.key,
  ...
  @override
  ConsumerState<DistPaysSellerDetail> createState() =>
      _DistPaysSellerDetailState();
}

class _DistPaysSellerDetailState extends ConsumerState<DistPaysSellerDetail> {
