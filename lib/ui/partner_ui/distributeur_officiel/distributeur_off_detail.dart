...
class DistributeurOffiDetailPartner extends StatefulWidget {
  const DistributeurOffiDetailPartner({
    super.key,
  });

  @override
  State<DistributeurOffiDetailPartner> createState() =>
      _DistributeurOffiDetailPartnerState();
}

class _DistributeurOffiDetailPartnerState
    extends State<DistributeurOffiDetailPartner> {
