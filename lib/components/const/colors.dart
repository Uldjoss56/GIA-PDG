...
const Color myPink = Color(0xFFAF00B0);
const Color myPinkAA = Color(0xAAAF00B0);
const Color myPink55 = Color(0x55AF00B0);
const Color myPink22 = Color(0x22AF00B0);

const Color myPink01 = Color(0xFF89028A);
const Color myPink01AA = Color(0xAA89028A);
const Color myPink0155 = Color(0x5589028A);
const Color myPink0122 = Color(0x2289028A);

const Color myPink02 = Color(0xFFFFABFF);
const Color myBlue = Color(0xFF014EBF);
...
/*
const selectedColor = Color.fromARGB(255, 118, 1118, 245);
const unselectedColor = Color(0xff5f636B);
*/